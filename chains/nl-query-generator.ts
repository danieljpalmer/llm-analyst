...
export default defineChain({
  ...
  setup({ params, step, code }) {
    ...
    const { tableName, tableColumns, amountToGenerate, ignoreQuestions } = params;
...
Give me a JSON array of the top ${amountToGenerate} questions you might want to ask of this table. Do NOT ask any of these questions: ${ignoreQuestions}.`,
      system_prompt: 'You are a business analyst. You must respond with good questions to ask of your SQL database. You should respond in the format: [question].'
    });
